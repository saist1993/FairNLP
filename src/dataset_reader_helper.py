...
def get_celeb_data(load_data_size=None):
    ...
    df = pd.read_csv(os.path.join(folder_location, 'data/celebA/list_attr_celeba.csv'), sep=';')
...
def get_adult_data(load_data_size=None):
    ...
    # src_path = os.path.dirname(os.path.realpath(__file__))
    df = pd.read_csv(os.path.join(folder_location, 'data/adult/adult.csv'))
...
def get_german_data(load_data_size=None):
    ...
    src_path = os.path.dirname(os.path.realpath(__file__))
    df = pd.read_csv(os.path.join(folder_location, 'data/german/german.csv'))
...
def get_compas_data(load_data_size=None):
    ...
    src_path = os.path.dirname(os.path.realpath(__file__))
    df = pd.read_csv(os.path.join(folder_location, 'data/compas/propublica-recidivism.csv'))
...
def get_dutch_data(load_data_size=None):
    ...
    src_path = os.path.dirname(os.path.realpath(__file__))
    df = pd.read_csv(os.path.join(folder_location, 'data/dutch/dutch.csv'))
